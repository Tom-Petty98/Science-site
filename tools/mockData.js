const TypedQuestions = [
  ...
  },
  {
    ...
    num_of_answers: 4,
    awnsers: [
      "Both the candle and the mouse need something from the air to survive.",
      "Both the candle and the mouse need the same thing from the air to survive.",
      "The candle in c gets smaller so it also needs wax to burn.",
      "Whatever the candle and the mouse needs from the air. It is somehow replaced by the plant.",
    ],
    hints: {
      one: "",
      two: "",
